...
--              TU_HOBBY,         TU_RESUME,      TU_INTRODUCTION,  TU_MEMO
--      FROM    USER_DETAIL
--              INNER JOIN TEMP_USER TU ON  (USER_DETAIL.UD_UM_CODE = TU.TU_CODE)
--                                      AND (TU_WORK_ID = VAR_WORK_ID)
--                                      AND (TU_WORK_USER = VAR_WORK_USER)
--    )
--  SET
--    UD_GENDER         = TU_GENDER,
...
--    UPDATE
--      (
--        SELECT  UI_UM_CODE, UI_FACE_NAME, UI_FACE_PATH,
--                UI_SIGN_NAME, UI_SIGN_PATH,
--                UI_GET_USER,  UI_GET_DATE,
--                TU_FACE_NAME, TU_FACE_PATH,
--                TU_SIGN_NAME, TU_SIGN_PATH
--        FROM    USER_IMAGE
--                INNER JOIN TEMP_USER TU ON  (USER_IMAGE.UI_UM_CODE = TU.TU_CODE)
--                                        AND (TU_WORK_ID = VAR_WORK_ID)
--                                        AND (TU_WORK_USER = VAR_WORK_USER)
--      )
--    SET
...
--      UI_GET_DATE   = SYSDATE
--  WHERE (UI_UM_CODE = '00007')
--      ;
SYS.DBMS_OUTPUT.PUT_LINE('4');
